...
# Restart script for gentle-cliff API Service

echo "=== Restarting gentle-cliff API Service ==="

# Stop the service if running
if systemctl is-active --quiet gentle-cliff-api.service; then
    echo "Stopping gentle-cliff service..."
    sudo systemctl stop gentle-cliff-api.service
...
# Start the service
echo "Starting gentle-cliff service..."
sudo systemctl start gentle-cliff-api.service
